...
public class HardArenaMob implements ArenaMob {
    private final MythicMob spade = MythicBukkit.inst().getMobManager().getMythicMob("HardSpadeSoldier").orElse(null);
    private final MythicMob heart = MythicBukkit.inst().getMobManager().getMythicMob("HardHeartSoldier").orElse(null);
